...
void DebugScene::OnMouseMessage(int32_t button, int32_t x, int32_t y)
{
...
void DebugScene::Animate(int32_t value)
{
	_inst->Moving(value);
	glutTimerFunc(_inst->_info[_inst->_tri[value]].first * 10, Animate, value);
}

void DebugScene::Moving(int32_t index)
{
